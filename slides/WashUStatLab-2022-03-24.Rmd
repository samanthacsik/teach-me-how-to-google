...
date: "<span style = 'font-size: 85%;'>R-Ladies St. Louis | February 2022</span><br><span style = 'font-size: 65%;'>Slides & source code available on [GitHub](https://github.com/samanthacsik/teach-me-how-to-google)</span>"
output:
...
<span style = 'font-size: 130%;'>Brown School StatLab, Washington University in St. Louis | March 2022</span>   

Slides & source code available on [`r fontawesome::fa("github", fill = "#93C6C2", a11y = "sem")`](https://github.com/samanthacsik/teach-me-how-to-google)

.footnote[
[Original talk](https://github.com/UCSB-MEDS/teach-me-how-to-google) developed for the [Master of Environmental Data Science Program](https://bren.ucsb.edu/masters-programs/master-environmental-data-science) (MEDS) at UC Santa Barbara's Bren School of Environmental Science and Management.
]
---
...
<span style = 'font-size: 120%;'>`r fontawesome::fa("power-off", fill = "#05859B", a11y = "sem")`  Restart R (or your Jupyter kernel, SAS, SPSS, etc.) </span>
...
### <span style = 'font-size: 100%;'>`r fontawesome::fa("power-off", fill = "#05859B", a11y = "sem")`  Restart R (or your Jupyter kernel, SAS, SPSS, etc.)</span>
...
Check out some of these additional resources for common error messages and strategies for fixing them:

**R:**

  * <span style = 'font-size: 80%;'>[Common R Error Messages](https://www.programmingr.com/r-error-messages/), on [ProgrammingR](https://www.programmingr.com/)</span>
    
  * <span style = 'font-size: 80%;'>[Common R Programming Errors Faced by Beginners](https://www.r-bloggers.com/2016/06/common-r-programming-errors-faced-by-beginners/), on [R-bloggers](https://www.r-bloggers.com/)</span>
    
  * <span style = 'font-size: 80%;'>[R Error Message Cheat Sheet](http://varianceexplained.org/courses/errors/), by David Robinson on his blog, [Variance Explained](http://varianceexplained.org/)</span>
    
  * <span style = 'font-size: 80%;'>[How to: Interpret Common Errors in R](https://warin.ca/posts/rcourse-howto-interpretcommonerrors/), by [Thierry Warin](https://warin.ca/)</span>
  
**Python:**

* <span style = 'font-size: 80%;'>[Common error messages (and how to fix them)](https://github.com/JonathanReeve/course-computational-literary-analysis/blob/master/Resources/errors.md), by [Jonathan Reeve](https://github.com/JonathanReeve) as part of the [Introduction to Computational Literary Analysis](Introduction to Computational Literary Analysis) course at UC Berkeley</span>

**SAS:**

* <span style = 'font-size: 80%;'>[Common Error Messages in SAS](https://stats.oarc.ucla.edu/sas/modules/common-error-messages-in-sas/), by [UCLA's Advanced Research Computing Group](https://stats.oarc.ucla.edu/)</span>

* <span style = 'font-size: 80%;'>[Diagnosing and Avoiding Errors](https://documentation.sas.com/doc/en/pgmsascdc/9.4_3.5/basess/n0qrfzc32pn7n6n1usggo9hw8jup.htm), from the [SAS Programming Documentation](https://documentation.sas.com/doc/en/pgmsascdc/9.4_3.5/pgmsaswlcm/home.htm)</span>

---
### <span style = 'font-size: 120%;'>`r fontawesome::fa("file-alt", fill = "#05859B", a11y = "sem")`  Double-check the documentation</span>

<span style = 'font-size: 70%;'>While documentation can sometimes be tricky to read, it provides critical info for understanding how to use a package or function.</span>

<span style = 'font-size: 70%;'>Access the documentation for any package or function that you have loaded into R by either typing `?function_name` or `help(function_name)` in your console. If you search for a function from a package that is not currently loaded, R will prompt you to type `??function_name`.</span>

.footnote[
<span style = 'font-size: 75%;'>*Similar to R,* `help()` *can be used in your Python console to return information on Python objects.*</span>
]

--

<span style = 'font-size: 70%;'>Some important components:</span>
...
<span style = 'font-size: 100%;'>`r fontawesome::fa("google", fill = "#05859B", a11y = "sem")`  General Googling tips:</span>
  ...
  - <span style = 'font-size: 75%;'>[language/software] + error message</span>
...
---
## A curated **vocabulary list** of language-specific terminology may help
...
<span style = 'font-size: 70%;'>The function below (written in R) converts a temperature between Celsius and Fahrenheit, and vice versa. It takes three arguments:</span>
...
Put your Googling and debugging skills to the test!
...
More than one solution may exist for each problem. Note the steps (Googling, looking at documentation, reading error messages, etc.) you take to arrive at your solution and compare with a friend!
