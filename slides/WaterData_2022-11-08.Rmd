...
<span style = 'font-size: 130%;'>ENV 193SW Water Data | Fall 2022</span>   
...
### But first, who am I and how'd I land myself here?
...
.pull-right[
`r fontawesome::fa("smile", fill = "#05859B", a11y = "sem")` I'm Sam Csik (pronounced "chick")

<br>

`r fontawesome::fa("cat", fill = "#05859B", a11y = "sem")` `r fontawesome::fa("cat", fill = "#05859B", a11y = "sem")` `r fontawesome::fa("dog", fill = "#05859B", a11y = "sem")` I have two cats and a dog 

<br>

`r fontawesome::fa("hiking", fill = "#05859B", a11y = "sem")` Hiking is my favorite pastime 

<br>

`r fontawesome::fa("palette", fill = "#05859B", a11y = "sem")` I recently took up pottery (check out [SBCC's School of Extended Learning](https://www.sbcc.edu/extendedlearning/) for lots of *free* classes)
]
...
<span style = 'font-size: 90%;'>I *never* imagined that I'd be an environmental data scientist (let alone teach others about it).</span>
...
knitr::include_graphics("media/BS.png")
```
...
```{r, out.width = '120%', echo = FALSE}
knitr::include_graphics("media/MS.png")
```
...
```{r, out.width = '120%', echo = FALSE}
knitr::include_graphics("media/colearning.png")
```
...
```{r, out.width = '120%', echo = FALSE}
knitr::include_graphics("media/fellow.png")
```
...
```{r, out.width = '120%', echo = FALSE}
knitr::include_graphics("media/DTC.png")
```

---
### Joining co-learning communities can be invaluable in your growth as data scientists

.center[
```{r, out.width = '90%', echo = FALSE}
knitr::include_graphics("media/colearning_communities.png")
```
.center[
<span style = 'font-size: 80%;'>Learn more about these awesome, local (Santa Barbara-area) professional development and coding communities: [R-Ladies Santa Barbara](https://www.meetup.com/rladies-santa-barbara/), [Santa Barbara Women in STEM](https://www.sbwomeninstem.org/), [UCSB Carpentries](https://ucsbcarpentry.github.io/), the [Data Analysis and Coding Club (DANC)](https://www.instagram.com/danc.ucsb/?hl=en), & [Central Coast Python](meetup.com/central-coast-python/).</span>
]
]
...
<span style = 'font-size: 75%;'>What's included in documentation varies by function and package. Some other important components include:</span>
  ...
  <span style = 'font-size: 65%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **Usage:** shows the various arguments to need to specify. Some are necessary, some are optional. Default values are shown here (See `ggplot` example on [previous slide]())</span>
  
  <span style = 'font-size: 65%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` **Arguments:** briefly describes what each argument is/takes as a value (See `ggplot` example on [previous slide]())</span> 
...
<span style = 'font-size: 80%;'>You don't need to create excessively long variable names, but being clear is important -- plus RStudio's autocomplete functionality makes retyping longer variable names a breeze!</span>
...
ggplot(data = penguins, aes(x = species, y = body_mass_g)) + 
  ...
  scale_color_manual(values = c("#FF8C02", "#A93FF1", "#148F90")) + 
  scale_shape_manual(values = c(15, 16)) + 
  
  # add nicer axis labels + title + caption
  labs(title = "Body mass of female vs. male adelie, chinstrap, and gentoo penguins",
