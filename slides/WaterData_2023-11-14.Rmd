...
<span style = 'font-size: 130%;'>ENV 193SW Water Data | Fall 2023</span>   
...
`r fontawesome::fa("car", fill = "#05859B", a11y = "sem")` My husband and I recently started restoring a 1990 Mazda Miata! YouTube has become our best friend.
]
...
<span style = 'font-size: 100%;'>`r fontawesome::fa("google", fill = "#05859B", a11y = "sem")`  General Googling tips:</span>
  ...
  - <span style = 'font-size: 75%;'>"R" and/or "tidyverse" + error message</span>
